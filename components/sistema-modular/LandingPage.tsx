...
function Footer() {
  return (
    <footer className="relative z-10 rounded-b-[28px] bg-[#101112] px-5 py-14 text-white shadow-[0_28px_80px_rgba(0,0,0,0.32)] sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-10 border-t border-white/10 pt-10 lg:grid-cols-[1.3fr_0.8fr_0.8fr_0.8fr]">
        <div>
          <div className="flex items-center gap-3">
...
function FooterBackdrop() {
  return (
    <section
      aria-hidden="true"
      className="footer-word-reveal relative -mt-7 min-h-[46vh] overflow-hidden bg-[#101112] bg-fixed"
    >
      <p className="footer-word-sticky select-none text-center text-[clamp(9rem,34vw,35rem)] font-semibold uppercase leading-[0.74] tracking-normal text-white/[0.12]">
        NEXO
      </p>
    </section>
  );
